...
public  class MyLookAndFeel {
	...
	public static final String[] UIArry = new String[]{
			MyLookAndFeel.SYS_METAL,
			MyLookAndFeel.SYS_CDE_MOTIF,
			MyLookAndFeel.SYS_WINDOWS,
			MyLookAndFeel.SYS_WINDOWS_CLASSIC,
			MyLookAndFeel.JTATTOO_ACRYL,
			MyLookAndFeel.JTATTOO_AERO,
			MyLookAndFeel.JTATTOO_ALUMINUM,
			MyLookAndFeel.JTATTOO_BERNSTEIN,
			MyLookAndFeel.JTATTOO_FAST,
			MyLookAndFeel.JTATTOO_HIFI,
			"MyLookAndFeel.JTATTOO_LUNA"
	};
}
